//release 20 balls 
//create bigger paddles so that user can attempt to keep all balls contained 
//i tried to create an array of 20 balls, however it says that the integer 'i' cannot be identified?
